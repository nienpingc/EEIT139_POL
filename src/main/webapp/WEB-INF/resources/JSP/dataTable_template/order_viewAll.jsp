...
<body class="sb-nav-fixed">
	...
	List<OrderInfo> rsList = new ArrayList<OrderInfo>();
	rsList = dao.searchAll();
			...
			<main>
				<div class="container-fluid px-4">
					...
					<div class="card mb-4" style="border:0">
						<form action="order_select" method="post">
							依入住日期查詢
					...
					<div class="card mb-4">
						...
						<div class="card-body">
							...
							<div>
								...
								<form style="display:inline" action="JSP/order/order_deleteAll.jsp" method="post">
									<input style="margin-left:10px;display:inline"
										class="btn-warning" type="submit" value="刪除選中"> <input
									...
									<table id="datatablesSimple" >
										...
										<tbody>
											...
											<tr>
												...
												<a class="btn btn-primary" href="JSP/order/order_updateId.jsp?orderId=<%=rs%>">修改</a></td>
												<td class="text-center">
												<a class="btn btn-danger" href="JSP/order/order_delete.jsp?orderId=<%=rs%>">刪除</a></td>
											</tr>
											<%
											}
											%>
