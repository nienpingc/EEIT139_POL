...
<!-- 	從這邊開始改 -->
	...
	<table class="table table-striped">
		...
		<tr>
			...
			<td><input type="text" id="title" name="h_title" size="30" value="${houseInfo.h_title}"></td>
		</tr>
		<tr>	
			<td><label for="price">
				房屋費用:
			</label></td>
			<td><input type="number" id="price" name="h_price" size="30" value="${houseInfo.h_price}"></td>
		</tr>
		<tr>	
			<td><label for="address">
				房屋地址:
			</label></td>
			<td><input type="text" id="address" name="h_address" size="100" value="${houseInfo.h_address}"></td>
		</tr>
		<c:choose>
		...
		<tr>
			...
			<td><label for="single">
				<input type="radio" id="single" name="h_type" value="1">單人房
			</label></td>
		</tr>
		<tr>
			<td></td>
			<td><label for="double">
				<input type="radio" id="double" name="h_type" value="2" checked>雙人房
			</label></td>
		</tr>
		<tr>
			<td></td>
		...
		<tr>
			<td></td>
			<td><label for="quadruple">
				<input type="radio" id="quadruple" name="h_type" value="4" checked>四人房
			</label></td>
		</tr>
		</c:when>
		</c:choose>
		<tr>	
			...
			<td><textarea id="about" name="h_about" cols="30" rows="10">${houseInfo.h_about}</textarea></td>
		</tr>
		
		</tbody>		
	</table>
	<div class="divInput">
			<input type="submit" class="btn btn-primary" value="修改房屋">
	</div>
	</div>
	</form>
	</div>
